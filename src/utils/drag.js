    ...
    return {
      ...
      onTouchStart: touchEvent => {
        ...
        const touchEndHandler = moveEvent => {
          const moveX = moveEvent.changedTouches[0].pageX - touchEvent.changedTouches[0].pageX;
          const moveY = moveEvent.changedTouches[0].pageY - touchEvent.changedTouches[0].pageY;
